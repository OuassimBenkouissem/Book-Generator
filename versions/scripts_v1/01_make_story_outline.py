...
def main():
    ...
    try:
        ...
        with open(input_file_path, 'r', encoding='utf-8') as file:
            prompt_text = "Turn the following text into a 100 chapter story outline. For each chapter, provide a detailed, long paragraph describing the events and key developments.\n\n" + file.read()
